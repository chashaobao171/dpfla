...
# VisDrone + YOLO 配置
def run_visdrone_yolo():
    """VisDrone数据集 + YOLO模型配置"""
    return {'dataset_name': 'VisDrone', 'model_name': 'YOLO'}


def get_visdrone_labels_dict():
    """VisDrone数据集的10个类别"""
    return {
        'pedestrian': 0,
        'people': 1,
...
def replace_car_with_truck():
    """VisDrone攻击配置: 将car误分类为truck"""
    return {'source_class': 3, 'target_class': 5}
